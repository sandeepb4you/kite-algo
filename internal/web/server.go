...
func (s *Server) routes() http.Handler {
	...
	mux.Handle("GET /options", page(s.handleOptions))
	mux.Handle("GET /history", page(s.handleHistory))
	...
	mux.Handle("GET /api/option-candles", page(s.handleOptionCandlesJSON))
	mux.Handle("POST /api/capture/run", page(s.handleCaptureRun))
	...
	mux.Handle("GET /partials/capture", page(s.handleCaptureFragment))
